...
NPZ_PATH = BASE_DIR / "data" / "npz" / "260623_sub2_yjkim.npz"
OUT_DIR = BASE_DIR / "data" / "processed" / "sub2_yjkim" / "260623_combination"
...
def add_patient_day_args(parser):
    ...
    parser.add_argument("--data-root", type=Path, default=BASE_DIR / "data" / "processed")
    parser.add_argument("--checkpoint-root", type=Path, default=BASE_DIR / "checkpoints")
...
def main():
    # 학습 설정은 configs/train_config_v1.json에서 수정
    parser = argparse.ArgumentParser()
    parser.add_argument("--config", type=Path, default=CONFIG_DIR / "train_config_v1.json")
