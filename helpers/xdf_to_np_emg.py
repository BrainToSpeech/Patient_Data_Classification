...
def mainEEG(file_path, channels, select_epoch, lower_bound_freq, upper_bound_freq):
    ...
    if np.isclose(sfreq, 2000):
        raw.resample(500)
        sfreq = raw.info["sfreq"]
        print("  [Resample] 2000 Hz -> 500 Hz")
...
def save_data(root_dir, target_dir, subject_filename, X, y):
    ...
    save_path = os.path.join(root_dir, target_dir, f"{subject_filename}_emg.npz")
...
target_dir = os.path.join('data')  # save preprocessed data
...
upper_bound_freq = 249

# 지정된 폴더 내의 모든 XDF 파일을 처리
xdf_files = [
    os.path.join(root_dir, "260408_sub1_hjlee.xdf"),
    os.path.join(root_dir, "260422_sub1_hjlee.xdf"),
    os.path.join(root_dir, "260506_sub1_hjlee.xdf"),
    os.path.join(root_dir, "260520_sub1_hjlee.xdf"),
    # os.path.join(root_dir, "260527_sub2_yjkim.xdf"),
    # os.path.join(root_dir, "260528_sub2_yjkim.xdf"),
    # os.path.join(root_dir, "260601_sub2_yjkim.xdf"),
    os.path.join(root_dir, "260602_sub1_hjlee.xdf"),
    # os.path.join(root_dir, "260602_sub2_yjkim.xdf"),
    os.path.join(root_dir, "260617_sub1_hjlee.xdf"),
    # os.path.join(root_dir, "260623_sub2_yjkim.xdf"),
]
